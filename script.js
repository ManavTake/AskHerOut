function startQuestions() {
  ...
  function answerNo() {
    ...
    document.getElementById("init").innerText = "YEY YEY 🎉🎉🎉";
    document.getElementById("message").style.display = "block";
    document.getElementById("messageText").innerText = "No worries, I know love takes time. So can we spend some time together and see if something beautiful blossoms?";
    showConfetti()
